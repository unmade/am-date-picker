!function(e,t){"use strict";function a(a,n,o){function i(){for(var a=["backButtonText","cancelButton","inputLabel","maxYear","minYear","locale","popupDateFormat","todayButton","prevIcon","nextIcon"],n=0;n<a.length;n++)o.hasOwnProperty(a[n])&&(e.isDefined(x[a[n]])||(x[a[n]]=o[a[n]]));x.moment=t(x.Date||new Date),x.moment.locale(x.locale),x.monthYear=t(x.Date||new Date),x.days=[],x.daysOfWeek=[t.weekdaysMin(1),t.weekdaysMin(2),t.weekdaysMin(3),t.weekdaysMin(4),t.weekdaysMin(5),t.weekdaysMin(6),t.weekdaysMin(0)],x.years=[];var i=x.minYear||1920,c=x.maxYear||2020;x.minDate&&(i=Math.max(i,t(x.minDate).year())),x.maxDate&&(c=Math.min(c,t(x.maxDate).year()));for(var r=i;c>=r;r++)x.years.push(r);y(!!x.Date)}function c(){a.cancel()}function r(){a.hide(x.moment.toDate())}function m(){x.yearSelection=!0,n(function(){var t=e.element(document.querySelector(".am-date-picker__year-selector")),a=e.element(document.querySelector(".am-date-picker__year--is-active")),n=a[0].getElementsByTagName("p")[0].offsetHeight;t[0].scrollTop=a[0].offsetTop-t[0].offsetTop-t[0].clientHeight/2+n/2})}function l(){x.yearSelection=!1}function s(){(!x.maxDate||x.monthYear.isBefore(x.maxDate,"month"))&&(x.monthYear.add(1,"month"),y(),u())}function u(){x.change=!1,x.next=!0,n(function(){x.change=!0},g)}function d(){x.next=!1,x.change=!1,n(function(){x.change=!0},g)}function p(){(!x.minDate||x.monthYear.isAfter(x.minDate,"month"))&&(x.monthYear.subtract(1,"month"),y(),d())}function D(){var e=new Date;x.moment=t(e),x.ngModelMoment=t(e),x.yearSelection&&x.hideYearSelection(),y()}function f(t){t.disabled||(x.moment=t,x.monthYear=e.copy(t),y())}function h(e){x.hideYearSelection(),x.monthYear.year(e),y()}function y(a){x.days=[],x.emptyFirstDays=[];for(var n=x.monthYear.clone().date(0),o=e.copy(x.monthYear).date(1),i=e.copy(o).endOf("month"),c=e.copy(i).date(),r=0===o.day()?6:o.day()-1;r>0;r--)x.emptyFirstDays.push({});for(var m=0;c>m;m++){var l=n.add(1,"days").clone();l.selected=a!==!1&&l.isSame(x.moment,"day"),l.today=l.isSame(t(),"day"),e.isDefined(x.minDate)&&l.isBefore(x.minDate,"day")&&(l.disabled=!0),e.isDefined(x.maxDate)&&l.isSameOrAfter(x.maxDate,"day")&&(l.disabled=!0),x.days.push(l)}x.isTodayDisabled=e.isDefined(x.minDate)&&t().toDate()<x.minDate||e.isDefined(x.maxDate)&&t().toDate()>x.maxDate}var x=this;x.cancel=c,x.hide=r,x.displayYearSelection=m,x.hideYearSelection=l,x.previousMonth=p,x.nextMonth=s,x.select=f,x.selectYear=h,x.today=D,x.isTodayDisabled=!1,x.yearSelection=!1,x.change=!0;var g=110;i()}function n(){return{restrict:"AE",templateUrl:"am-date-picker.html",bindToController:{Date:"=ngModel",allowClear:"=?amAllowClear",cancelButton:"@?amCancelButton",inputDateFormat:"@?amInputDateFormat",inputLabel:"@?amInputLabel",maxDate:"=?amMaxDate",minDate:"=?amMinDate",maxYear:"=?amMaxYear",minYear:"=?amMinYear",popupDateFormat:"@?amPopupDateFormat",showInputIcon:"=?amShowInputIcon",todayButton:"@?amTodayButton"},controller:o,controllerAs:"amDatePicker",scope:{},replace:!0}}function o(n,o,i,c){function r(){for(var t=["backButtonText","cancelButton","inputLabel","maxYear","minYear","popupDateFormat","todayButton","prevIcon","nextIcon","calendarIcon","allowClear","clearIcon","showInputIcon","inputDateFormat","inputLabel","locale","minDate","maxDate"],a=0;a<t.length;a++)c.hasOwnProperty(t[a])&&(e.isDefined(u[t[a]])||(u[t[a]]=c[t[a]]));m()}function m(){u.value=u.Date?t(u.Date).format(u.inputDateFormat):void 0}function l(){u.Date=void 0,m()}function s(t){i.show({clickOutsideToClose:!0,controller:a,controllerAs:"dialog",bindToController:!0,parent:e.element(document.body),targetEvent:t,templateUrl:"am-date-picker_content.tmpl.html",locals:{Date:u.Date,minDate:u.minDate,maxDate:u.maxDate,todayButton:u.todayButton,cancelButton:u.cancelButton,backButtonText:u.backButtonText}}).then(function(e){u.Date=e,m()})}var u=this;u.clearDate=l,u.openPicker=s,u.isTodayDisabled=!1,u.yearSelection=!1,u.change=!0,r()}function i(){var e={};e.allowClear=!0,e.backButtonText="Back",e.inputDateFormat="LL",e.maxYear=2020,e.minYear=1920,e.locale="en",e.popupDateFormat="ddd, MMM D",e.showInputIcon=!1,e.calendarIcon="/dist/images/icons/ic_today_24px.svg",e.clearIcon="/dist/images/icons/ic_close_24px.svg",e.nextIcon="/dist/images/icons/ic_chevron_right_18px.svg",e.prevIcon="/dist/images/icons/ic_chevron_left_18px.svg",this.setIcons=function(t){for(var a in t)e[a]=t[a]},this.setOptions=function(t){for(var a in t)e[a]=t[a]};var t=["allowClear","backButtonText","cancelButton","inputDateFormat","inputLabel","maxYear","maxDate","minDate","minYear","locale","popupDateFormat","showInputIcon","todayButton","calendarIcon","clearIcon","nextIcon","prevIcon"];t.forEach(function(t){var a=t.charAt(0).toUpperCase()+t.substr(1);this["set"+a]=function(a){return e[t]=a,this}},this),this.$get=function(t,a){return new c(e,t,a)},this.$get.$inject=["$mdDialog","$q"]}function c(e,t,a){function n(e,t,a){Object.defineProperty(e,t,{__proto__:null,get:function(){return a}})}var o=["allowClear","backButtonText","cancelButton","showInputIcon","inputLabel","maxDate","minDate","maxYear","minYear","locale","inputDateFormat","popupDateFormat","todayButton","calendarIcon","prevIcon","nextIcon","clearIcon"];for(var i in o)n(this,o[i],e[o[i]])}e.module("am.date-picker",["ngMaterial","ngAnimate"]).directive("amDatePicker",n).provider("amDatePickerConfig",i).controller("amDatePickerDialog",a),a.$inject=["$mdDialog","$timeout","amDatePickerConfig"],o.$inject=["$scope","$timeout","$mdDialog","amDatePickerConfig"]}(window.angular,window.moment);
