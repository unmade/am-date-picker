!function(){"use strict";function e(){var e=this;e.allowClear=!0,e.backButtonText="Back",e.inputDateFormat="LL",e.maxYear=2020,e.minYear=1920,e.locale="en",e.popupDateFormat="ddd, MMM D",e.showInputIcon=!1,e.calendarIcon="/dist/images/icons/ic_today_24px.svg",e.clearIcon="/dist/images/icons/ic_close_24px.svg",e.nextIcon="/dist/images/icons/ic_chevron_right_18px.svg",e.prevIcon="/dist/images/icons/ic_chevron_left_18px.svg",e.setIcons=function(t){for(var a in t)e[a]=t[a]},e.setOptions=function(t){for(var a in t)e[a]=t[a]},this.$get=function(){return new t(e)}}function t(e){function t(e,t,a){Object.defineProperty(e,t,{__proto__:null,get:function(){return a}})}var a=["allowClear","backButtonText","cancelButton","inputLabel","maxDate","minDate","maxYear","minYear","locale","inputDateFormat","popupDateFormat","showInputIcon","todayButton","calendarIcon","prevIcon","nextIcon","clearIcon"];for(var n in a)t(this,a[n],e[a[n]])}function a(){return{restrict:"AE",templateUrl:"am-date-picker.html",require:["ngModel","amDatePicker"],scope:{allowClear:"=?amAllowClear",backButtonText:"@?amBackButtonText",cancelButton:"@?amCancelButton",inputDateFormat:"@?amInputDateFormat",inputLabel:"@?amInputLabel",locale:"@?amLocale",maxDate:"=?amMaxDate",minDate:"=?amMinDate",maxYear:"=?amMaxYear",minYear:"=?amMinYear",popupDateFormat:"@?amPopupDateFormat",showInputIcon:"=?amShowInputIcon",todayButton:"@?amTodayButton"},link:function(e,t,a,n){var o=n[0],l=n[1];l.configureNgModel(o)},controller:n,controllerAs:"amDatePicker",bindToController:!0,replace:!0}}function n(e,t,a,n){function o(){for(var e=["allowClear","backButtonText","cancelButton","inputLabel","maxDate","minDate","maxYear","minYear","locale","inputDateFormat","popupDateFormat","showInputIcon","todayButton","calendarIcon","prevIcon","nextIcon","clearIcon"],t=0;t<e.length;t++)n.hasOwnProperty(e[t])&&(angular.isDefined(k[e[t]])||(k[e[t]]=n[e[t]]));var a=angular.isDate(k.model);k.modelMoment=a?moment(angular.copy(k.model)):moment(),k.modelMoment.locale(k.locale),k.modelMomentFormatted=a?k.modelMoment.format(k.inputDateFormat):void 0,k.days=[];var o=moment.localeData(k.locale);k.daysOfWeek=[o._weekdaysMin[1],o._weekdaysMin[2],o._weekdaysMin[3],o._weekdaysMin[4],o._weekdaysMin[5],o._weekdaysMin[6],o._weekdaysMin[0]],k.years=[];for(var l=k.minYear||1920,i=k.maxYear||2020,r=l;i>=r;r++)k.years.push(r);d(),x()}function l(){k.ngModelCtrl.$setViewValue(void 0),k.model=void 0,k.modelMomentFormatted=void 0,d()}function i(){["minDate","maxDate","valid"].forEach(function(e){k.ngModelCtrl.$setValidity(e,!0)},k)}function r(e){k.ngModelCtrl=e,e.$render=function(){var e=k.ngModelCtrl.$viewValue;k.model=e,o()}}function m(){function e(){M(o),a.cancel()}function t(){a.hide()}var n=this,o=angular.copy(k.modelMoment);n.cancel=e,n.hide=t}function c(){k.yearSelection=!0,t(function(){var e=angular.element(document.querySelector(".am-date-picker__year-selector")),t=angular.element(document.querySelector(".am-date-picker__year--is-active")),a=t[0].getElementsByTagName("p")[0].offsetHeight;e[0].scrollTop=t[0].offsetTop-e[0].offsetTop-e[0].clientHeight/2+a/2})}function d(){k.days=[],k.emptyFirstDays=[];for(var e=angular.copy(k.modelMoment).date(0),t=angular.copy(k.modelMoment).date(1),a=angular.copy(t).endOf("month"),n=angular.copy(a).date(),o=0===t.day()?6:t.day()-1;o>0;o--)k.emptyFirstDays.push({});for(var l=0;n>l;l++){var i=angular.copy(e.add(1,"days"));i.disabled=angular.isDate(k.minDate)&&i.isBefore(k.minDate)||angular.isDate(k.maxDate)&&i.isAfter(k.maxDate),i.selected=angular.isDefined(k.modelMoment)&&i.isSame(k.modelMoment,"day")&&!i.disabled,i.today=i.isSame(moment(),"day"),k.days.push(i)}k.isTodayDisabled=angular.isDate(k.minDate)&&moment().toDate()<k.minDate||angular.isDate(k.maxDate)&&moment().toDate()>k.maxDate}function u(){k.yearSelection=!1}function s(){k.modelMoment.add(1,"month"),d(),p()}function p(){k.monthChanged=!1,k.next=!0,t(function(){k.monthChanged=!0},w)}function f(t){a.show({controller:m,controllerAs:"dialog",onRemoving:u,parent:angular.element(document.body),scope:e.$new(),targetEvent:t,templateUrl:"am-date-picker_content.tmpl.html"}).then(function(){v()})}function g(){k.next=!1,k.monthChanged=!1,t(function(){k.monthChanged=!0},w)}function D(){k.modelMoment.subtract(1,"month"),d(),g()}function y(){k.yearSelection&&k.hideYearSelection(),k.select(moment().locale(k.locale))}function M(e){e.disabled||(k.modelMoment=angular.copy(e),d())}function h(e){k.hideYearSelection(),M(k.modelMoment.year(e)),d()}function v(){k.model=k.modelMoment.toDate(),k.ngModelCtrl.$setViewValue(k.model),k.modelMomentFormatted=k.modelMoment.locale(k.locale).format(k.inputDateFormat),x()}function x(){var e,t=k.ngModelCtrl.$viewValue;i(),angular.isDate(t)?(e=moment(t),k.ngModelCtrl.$setValidity("minDate",e.isAfter(k.minDate)),k.ngModelCtrl.$setValidity("maxDate",e.isBefore(k.maxDate))):k.ngModelCtrl.$setValidity("valid",!1)}var k=this;k.clearDate=l,k.configureNgModel=r,k.displayYearSelection=c,k.hideYearSelection=u,k.previousMonth=D,k.nextMonth=s,k.select=M,k.selectYear=h,k.openPicker=f,k.today=y,k.model=null,k.ngModelCtrl=null,k.monthChanged=!0,k.isTodayDisabled=!1,k.yearSelection=!1;var w=110;e.$watch("amDatePicker.minDate",function(e,t){k.model&&k.modelMoment.isBefore(e)&&e&&(k.select(moment(e).locale(k.locale)),v()),d()}),e.$watch("amDatePicker.maxDate",function(e,t){k.model&&k.modelMoment.isAfter(e)&&e&&(k.select(moment(e).locale(k.locale)),v()),d()})}angular.module("am.date-picker",["ngMaterial","ngAnimate"]).directive("amDatePicker",a).provider("amDatePickerConfig",e),n.$inject=["$scope","$timeout","$mdDialog","amDatePickerConfig"]}();
