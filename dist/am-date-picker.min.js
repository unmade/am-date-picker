!function(){"use strict";function e(){var e=this;e.allowClear=!0,e.backButtonText="Back",e.cancelButtonText="Cancel",e.inputDateFormat="LL",e.maxYear=2020,e.minYear=1920,e.locale="en",e.popupDateFormat="ddd, MMM D",e.showInputIcon=!1,e.calendarIcon="/dist/images/icons/ic_today_24px.svg",e.clearIcon="/dist/images/icons/ic_close_24px.svg",e.nextIcon="/dist/images/icons/ic_chevron_right_18px.svg",e.prevIcon="/dist/images/icons/ic_chevron_left_18px.svg",e.setIcons=function(n){for(var t in n)e[t]=n[t]},e.setOptions=function(n){for(var t in n)e[t]=n[t]},this.$get=function(){return e}}function n(){return{restrict:"AE",templateUrl:"am-date-picker.html",scope:{ngModel:"=",allowClear:"=?amAllowClear",inputDateFormat:"@?amInputDateFormat",inputLabel:"@?amInputLabel",maxDate:"=?amMaxDate",minDate:"=?amMinDate",maxYear:"=?amMaxYear",minYear:"=?amMinYear",popupDateFormat:"@?amPopupDateFormat",showInputIcon:"=?amShowInputIcon",todayButton:"@?amTodayButton"},controller:t,controllerAs:"amDatePicker",bindToController:!0,replace:!0}}function t(e,n,t,a){function o(){for(var e=["ngModel","allowClear","backButtonText","cancelButtonText","showInputIcon","inputLabel","maxDate","minDate","maxYear","minYear","locale","inputDateFormat","popupDateFormat","todayButton","calendarIcon","prevIcon","nextIcon","clearIcon"],n=0;n<e.length;n++)a.hasOwnProperty(e[n])&&(angular.isDefined(y[e[n]])||(y[e[n]]=a[e[n]]));y.moment.locale(y.locale),y.ngModelMoment=angular.isDefined(y.ngModel)?moment(angular.copy(y.ngModel)):moment(),y.ngModelMomentFormatted=angular.isDefined(y.ngModel)?moment(y.ngModel).format(y.inputDateFormat):void 0,y.days=[],y.daysOfWeek=[moment.weekdaysMin(1),moment.weekdaysMin(2),moment.weekdaysMin(3),moment.weekdaysMin(4),moment.weekdaysMin(5),moment.weekdaysMin(6),moment.weekdaysMin(0)],y.years=[];for(var t=y.minYear||1920,o=y.maxYear||2020,i=t;o>=i;i++)y.years.push(i);l()}function i(){y.ngModel=void 0,y.ngModelMomentFormatted=void 0,l()}function m(){function e(){a.model?y.select(a.modelMoment):y.clearDate(),t.cancel()}function n(){t.hide()}var a=this;a.model=angular.copy(y.ngModel),a.modelMoment=angular.copy(y.ngModelMoment),a.cancel=e,a.hide=n}function r(){y.yearSelection=!0,n(function(){var e=angular.element(document.querySelector(".am-date-picker__year-selector")),n=angular.element(document.querySelector(".am-date-picker__year--is-active")),t=n[0].getElementsByTagName("p")[0].offsetHeight;e[0].scrollTop=n[0].offsetTop-e[0].offsetTop-e[0].clientHeight/2+t/2})}function l(){y.days=[],y.emptyFirstDays=[];for(var e=angular.copy(y.ngModelMoment).date(0),n=angular.copy(y.ngModelMoment).date(1),t=angular.copy(n).endOf("month"),a=angular.copy(t).date(),o=0===n.day()?6:n.day()-1;o>0;o--)y.emptyFirstDays.push({});for(var i=0;a>i;i++){var m=angular.copy(e.add(1,"days"));m.selected=angular.isDefined(y.ngModel)&&m.isSame(y.ngModel,"day"),m.today=m.isSame(moment(),"day"),angular.isDefined(y.minDate)&&m.toDate()<y.minDate&&(m.disabled=!0),angular.isDefined(y.maxDate)&&m.toDate()>y.maxDate&&(m.disabled=!0),y.days.push(m)}y.isTodayDisabled=angular.isDefined(y.minDate)&&moment().toDate()<y.minDate||angular.isDefined(y.maxDate)&&moment().toDate()>y.maxDate}function c(){y.yearSelection=!1}function d(){y.ngModelMoment=y.ngModelMoment.add(1,"month"),l(),s()}function s(){y.change=!1,y.next=!0,n(function(){y.change=!0},h)}function u(n){t.show({clickOutsideToClose:!0,controller:m,controllerAs:"dialog",onRemoving:c,parent:angular.element(document.body),scope:e.$new(),targetEvent:n,templateUrl:"am-date-picker_content.tmpl.html"})}function g(){y.next=!1,y.change=!1,n(function(){y.change=!0},h)}function p(){y.ngModelMoment=y.ngModelMoment.subtract(1,"month"),l(),g()}function M(){var e=moment();y.ngModel=e.toDate(),y.ngModelMoment=angular.copy(e),y.ngModelMomentFormatted=e.format(y.inputDateFormat),y.yearSelection&&y.hideYearSelection(),l()}function f(e){e.disabled||(y.ngModel=e.toDate(),y.ngModelMoment=angular.copy(e),y.ngModelMomentFormatted=e.format(y.inputDateFormat),l())}function D(e){y.hideYearSelection(),y.ngModelMoment=y.ngModelMoment.year(e),l()}var y=this;y.clearDate=i,y.displayYearSelection=r,y.hideYearSelection=c,y.previousMonth=p,y.nextMonth=d,y.select=f,y.selectYear=D,y.openPicker=u,y.today=M,y.moment=moment,y.isTodayDisabled=!1,y.yearSelection=!1,y.change=!0;var h=110;o(),e.$watch("amDatePicker.minDate",function(e,n){e>y.ngModel&&y.select(moment(e)),l()}),e.$watch("amDatePicker.maxDate",function(e,n){e<y.ngModel&&y.select(moment(e)),l()})}angular.module("am.date-picker",["ngMaterial","ngAnimate"]).directive("amDatePicker",n).provider("amDatePickerConfig",e),t.$inject=["$scope","$timeout","$mdDialog","amDatePickerConfig"]}();
